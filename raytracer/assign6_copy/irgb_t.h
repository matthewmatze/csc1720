...
class irgb_t
{
   ...
   //operator overload to help with outputting integer rgb values
   
   friend ostream& operator<<(ostream& outs, irgb_t& amb){
      outs << fixed << setprecision(2) << amb.r <<" "<<amb.g<<" "<<amb.b;
      return outs;
   };
   
   friend istream& operator>>(istream& ins, irgb_t& amb){
